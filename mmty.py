...
# Generador de movimientos de placas de residentes de Monterrey.
...
try:
    while True:
        ...
        # veo si la placa ya salio para marcar su entrada
        ...
        # vuelvo a seleccionar una placa aleatoria y veo si ya entro para marcar su salida
        idxPlacaAleatorio = random.randint(muestraPlacasSP[0][0], muestraPlacasSP[len(dicPlacasMuestra)-1][0])
